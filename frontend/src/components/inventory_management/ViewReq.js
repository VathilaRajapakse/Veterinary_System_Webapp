 ...
 function refreshpage() {
  ...
  useEffect(() => {
    function getMedicine() {
      ...
      axois.get("http://localhost:8000/medicine/medicineIn")
        .then((res) => {
                ...
                <table Class = "table">
                    <thead id="app-table">
                        ...
                        <tr >
                            ...
                            <th className="order-table-header-col-1" scope="col">PRODUCT NAME</th>
                            <th className="order-table-header-col-1" scope="col">ITEM NO</th>
                            <th className="order-table-header-col-1" scope="col">CATEGORY</th>
                            <th className="order-table-header-col-1" scope="col">QUANTITY</th>
                            <th className="order-table-header-col-1" scope="col">MANUFACTURE DATE</th>
                            <th className="order-table-header-col-1" scope="col">EXPIRY DATE</th>
                    ...
                    {Medicine.filter(Medicine => 
                      ...
                      Medicine.item_no.toLowerCase().includes(serQuary)
                        ...
                        <tr className="order-table-row" key = {Medicine._id}>
                            ...
                            <td className="order-table-col-1">{Medicine.Manufacture_date.split('T')[0]}</td>
                            <td className="order-table-col-1">{Medicine.expiry_date.split('T')[0]}</td>
